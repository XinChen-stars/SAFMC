...
private:
  ...
  ros::Subscriber rviztargetposeSub_, targetexistSub_;
  ...
  Eigen::Vector4d geometric_attcontroller(const Eigen::Vector4d &ref_att,
                                          const Eigen::Vector3d &ref_acc,
                                          Eigen::Vector4d &curr_att);
  Eigen::Vector4d jerk_trackingcontroller(const Eigen::Vector4d &ref_att,
                                      const Eigen::Vector3d &ref_acc,
